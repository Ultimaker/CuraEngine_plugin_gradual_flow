...
#ifndef CURAENGINE_PLUGIN_GRADUAL_FLOW_UTILS_H
#define CURAENGINE_PLUGIN_GRADUAL_FLOW_UTILS_H


namespace plugin::gradual_flow::utils
{
...
} // namespace gradual_flow::utils

#endif //CURAENGINE_PLUGIN_GRADUAL_FLOW_UTILS_H
